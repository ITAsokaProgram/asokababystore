...
<head>
    ...
    <title>Kebijakan Privasi - Asoka Baby Store</title>
    ...
    <main class="max-w-4xl mx-auto px-4 py-12">
        <div class="bg-white rounded-xl shadow-lg p-8 md:p-12 border border-gray-200">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Kebijakan Privasi Asoka</h1>
            </div>
                    ...
                    <div class="space-y-4">
                        <div class="bg-pink-50 rounded-lg p-5 border border-pink-200">
                            <h3 class="font-bold text-gray-800 mb-2 flex items-center">
                                <i class="fas fa-user-edit text-pink-500 mr-2"></i>
                                Informasi yang Anda Berikan Secara Langsung
                            </h3>
                            <p class="text-gray-700">Nama, alamat email, dan nomor telepon</p>
                        </div>
                ...
                <div class="ml-14">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start">
                            ...
                            <span class="text-gray-700">Mengelola akun keanggotaan Anda</span>
                        </div>
                        <div class="flex items-start">
                            <i class="fas fa-check-circle text-green-500 mt-1 mr-3 flex-shrink-0"></i>
