<body>
    ...
    <header class="bg-white border-b border-gray-200 shadow-sm fixed top-0 w-full z-50">
        <div class="flex items-center justify-between h-16 px-4">
            ...
            <div class="flex items-center space-x-4">
                <a href="/in_beranda" class="flex items-center space-x-3 group">
                    <div class="relative">
                        <img src="/public/images/logo.png" alt="Asoka Baby Store" 
            ...
            <div class="flex items-center space-x-4">
                ...
                <button id="toggle-hide" 
                        class="hidden md:flex items-center justify-center w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-lg text-gray-600 hover:text-gray-800 transition-all duration-200">
                    <i class="fa-solid fa-angle-left text-sm"></i>
                </button>

                <!-- User Profile -->
                <div class="relative">
                    <button id="profile-img" class="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 transition-colors duration-200 group">
                        <div class="relative">
                            <img src="/public/images/pic-1.jpg" 
                                 class="w-8 h-8 rounded-full object-cover border-2 border-white shadow-sm group-hover:shadow-md transition-shadow duration-200">
                            <div class="absolute bottom-0 right-0 block h-2.5 w-2.5 bg-green-400 rounded-full border-2 border-white"></div>
                        </div>
                        <div class="hidden sm:block text-left">
                            <p class="text-sm font-medium text-gray-900" id="user-nama">User Name</p>
                    ...
                    <!-- Profile Dropdown -->
                    <div class="profile-card absolute right-0 top-12 bg-white rounded-xl shadow-lg border border-gray-200 w-56 transition-all duration-300 z-50 opacity-0 invisible" 
                         id="profile-card">
    ...
    <script src="/src/js/profile_user.js"></script>
