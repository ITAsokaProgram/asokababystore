...
$stmt = $conn->prepare("SELECT password FROM user_account WHERE inisial = ?");
...
if ($is_duplicate_account) {
    ...
    echo json_encode(['status' => 'error', 'message' => 'Kombinasi Nama Pengguna dan Password ini sudah digunakan. Silahkan gunakan password berbeda.']);
    exit;
}
