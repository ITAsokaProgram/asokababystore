...
try {
    ...
    if (isset($input['details']) && is_array($input['details'])) {
        ...
        try {
            ...
            // PERBAIKAN 1: Tambahkan top dan status di Query INSERT
            ...
            // PERBAIKAN 2: Tambahkan top dan status di Query UPDATE
            ...
            foreach ($details as $item) {
                ...
                if ($id) {
                    // Update: String type 16 char (ssssdsddsssssssi) untuk 16 variabel
                    ...
                    // Insert: String type harus 16 char (sssssdsddsssssss) untuk 16 variabel
                    // PERBAIKAN 3: Koreksi string types di sini (sebelumnya kurang satu 's')
