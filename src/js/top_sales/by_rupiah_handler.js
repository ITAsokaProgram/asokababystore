document.addEventListener("DOMContentLoaded", () => {
  ...
  async function exportToExcel() {
    ...
    try {
      ...
      const params = getUrlParams();
      const title = [["Laporan Top Sales (Rupiah)"]];
      const info = [
      ...
      XLSX.utils.book_append_sheet(wb, ws, "Top Sales Rupiah");
      const fileName = `Top_Sales_Rupiah_${params.tgl_mulai}_sd_${params.tgl_selesai}.xlsx`;
  ...
  async function exportToPDF() {
    ...
    try {
      ...
      doc.setFontSize(18);
      doc.text("Laporan Top Sales (Rupiah)", 14, 22);
      doc.setFontSize(11);
