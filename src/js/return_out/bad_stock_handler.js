  ...
  async function loadData() {
    ...
    try {
      ...
      if (pageSubtitle) {
        ...
        pageSubtitle.textContent = `Laporan Bad Stock Periode ${params.tgl_mulai} s/d ${params.tgl_selesai} - ${storeName}`;
        if (pageTitle) {
    ...
    function buildFakturHeaderRow(faktur, kodesupp, namasupp, nama_inisial) {
      ...
      return `
                        <tr class="header-faktur-row">
                            ...
                            <td colspan="8" class="px-4 py-1">Supplier: <strong>${
                              namasupp || ""
                            } ${inisial}</strong></td>
                        </tr>
                    `;
    ...
    function buildSubtotalFakturRow() {
      return `
                        <tr class="subtotal-row">
                            <td colspan="6" class="text-right px-4 py-2" style="font-style: italic;">Sub Total Faktur:</td>
