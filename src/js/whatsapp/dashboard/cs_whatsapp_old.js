...
async function handleManageLabels() {
    ...
    try {
        ...
        if (Array.isArray(selectedLabelIds)) {
            ...
            // const updateResponse = await fetch('/src/api/whatsapp/update_conversation_labels.php', {
            //     method: 'POST',
            //     headers: {
            //         'Content-Type': 'application/json',
            //         'Authorization': `Bearer ${token}`
            ...
            //         label_ids: selectedLabelIds.map(id => parseInt(id)) 
            //     })
            // });
            ...
            //     timer: 2000
            // });
            // currentConversationLabels = result.labels; 
