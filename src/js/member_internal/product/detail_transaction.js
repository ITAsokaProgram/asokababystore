// Enhanced function to show detail modal
function showDetailModal(data) {
  ...
  if (data[0].kd_cust) {
    ...
    content.innerHTML = `
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-bold text-green-600">${formatCurrency(
                                      data.map(item => item.nominal).reduce((sum, item) => sum + item, 0)
                                    )}</span>
                                </div>
                                <div class="flex justify-between">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="bg-green-50 rounded-lg p-4 text-center border border-green-200">
                            <div class="text-2xl font-bold text-green-600">${formatCurrency(
                              data[0].nominal
                            )}</div>
    ...
    <h3 class="text-lg font-semibold text-red-800">Tidak ada data</h3>
...
// Simpan data global untuk akses saat klik
