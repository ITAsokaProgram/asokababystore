      ...
      return `
          <tr class="hover:bg-gray-50 transition-colors duration-200 cursor-pointer" data-member="${
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="text-sm text-gray-600 font-mono">${item.kd_cust}</div>
            </td>
            <td class="px-6 py-4 whitespace-nowrap text-center">
  ...
  tbody.innerHTML = `
    <tr>
      <td colspan="5" class="px-6 py-8 text-center text-gray-500">
        ...
        <p class="text-gray-500">Data top sales akan muncul di sini</p>
      </td>
    </tr>
  `;
};
...
const updateSummaryCards = (summaryData) => {
  // Kosongkan atau sesuaikan jika ada summary card khusus
};
