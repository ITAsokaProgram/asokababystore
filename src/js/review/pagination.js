...
export const paginationReviewInternal = (page = 1, limit = 10, data, callbackRender) => {
  ...
  if (paginationContainer) {
    ...
    const createBtn = (label, targetPage, disabled = false, active = false) => {
      ...
      `;
      if (!disabled) {
        btn.addEventListener("click", () => paginationReviewInternal(targetPage, limit, data, callbackRender));
      }
      return btn;
    };
...
export default { paginationReviewInternal };
