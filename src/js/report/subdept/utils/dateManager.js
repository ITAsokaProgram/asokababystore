...
import { isValidDateRange } from './formatters.js';
...
class DateManager {
    ...
    _initializeDateInputs() {
        const startDateInput = document.getElementById(ELEMENT_IDS.DATE);
        const endDateInput = document.getElementById(ELEMENT_IDS.DATE1);
     ...
     */
    getStartDate() {
        const element = document.getElementById(ELEMENT_IDS.DATE);
     ...
     */
    getEndDate() {
        const element = document.getElementById(ELEMENT_IDS.DATE1);
        return element ? element.value : null;
    }
    ...
    /**
     * Get default date range (30 hari terakhir)
     * @private
