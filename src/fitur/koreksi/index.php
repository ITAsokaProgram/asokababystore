...
$menuHandler = new MenuHandler('koreksi_index');
...
<body class="bg-gray-50" x-data="{ 
                ...
                <div class="header-card p-4 rounded-2xl mb-4">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 class="text-xl font-bold text-gray-800 mb-1">Data Koreksi</h1>
                                <p class="text-xs text-gray-600">Laporan & Checking data koreksi faktur supplier.</p>
                            </div>
                        </div>
                        <a href="create.php"
                    ...
                    <div class="mt-4 grid grid-cols-1 md:grid-cols-4 gap-3">
                        <div id="btn-show-selisih"
                            ...
                            <div>
                                <h3 class="text-xs font-semibold text-gray-600 mb-1">Jumlah Selisih</h3>
                        ...
                        <div id="btn-show-rupiah-selisih"
                            ...
                            <div>
                                <h3 class="text-xs font-semibold text-gray-600 mb-1">Total Nilai Selisih</h3>
                                <p id="summary-total-rupiah-selisih" class="text-xl font-bold truncate text-pink-600">Rp
                                    0</p>
                                <p class="text-[10px] text-gray-500">Klik untuk detail</p>
                            </div>
                        </div>
                        ...
                        <div id="btn-show-missing"
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-gray-500">Ada di ERP, Belum Scan</p>
                            </div>
                        </div>
                        ...
                        <div id="btn-show-notfound"
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-gray-500">Ada Scan, Tdk Ada ERP</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table-modern" id="koreksi-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Kode Supplier</th>
                                    <th>No Faktur</th>
                                    <th class="text-right">Total Scan</th>
                                    <th>Keterangan</th>
                                </tr>
                            </thead>
            ...
            <div class="flex min-h-screen items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div x-show="detailModalOpen" x-transition:enter="ease-out duration-300"
                    ...
                    <div class="bg-pink-50 px-4 py-3 sm:px-6 flex justify-between items-center">
                        <h3 class="text-lg font-bold leading-6 text-pink-700">Detail Koreksi</h3>
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="mt-4 space-y-3">
                            <p class="text-[10px] font-bold tracking-wider text-gray-400 uppercase">Perbandingan Nilai
                            </p>

                            <div class="grid grid-cols-2 gap-2 text-sm">
                                <div class="bg-gray-50 p-3 rounded-lg">
                                    <span class="block text-xs text-gray-500 mb-1">Total Scan (Check)</span>
                                    <span class="font-bold text-gray-800"
                                        x-text="formatRupiah(detailData.total_koreksi)"></span>
                                </div>
                                <div class="bg-gray-50 p-3 rounded-lg">
                                    <span class="block text-xs text-gray-500 mb-1">Total ERP (System)</span>
                                    <span class="font-bold text-blue-600"
                                        x-text="formatRupiah(detailData.total_erp)"></span>
                                </div>
                            </div>

                            <div class="flex justify-between items-center bg-red-50 p-3 rounded-lg border border-red-100"
                                x-show="detailData.nilai_selisih_row != 0">
                                <span class="text-red-600 text-sm font-semibold">Selisih</span>
                                <span class="text-lg font-bold text-red-600"
                                    x-text="formatRupiah(Math.abs(detailData.nilai_selisih_row))"></span>
                            </div>
    ...
    <script src="../../js/koreksi/handler.js" type="module"></script>
