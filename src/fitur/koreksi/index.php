...
// Ganti 'koreksi_index' sesuai permission yang Anda set di database, atau comment jika belum ada
                    ...
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600">Laporan data koreksi faktur supplier.</p>
                            </div>
                        </div>
                        <a href="create.php"
                        ...
                        <table class="table-modern" id="koreksi-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Nama Supplier</th>
                                    <th>No Faktur</th>
                                    <th class="text-right">Total Koreksi</th>
                                    <th>Keterangan</th>
                                </tr>
                            </thead>
