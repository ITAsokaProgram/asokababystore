...
if (isset($product_response['response']['item_list'][0])) {
    ...
    // Get model/variant info if product has variants
    ...
    <main id="main-content" class="flex-1 p-6 ml-64">
        <section class="min-h-[85vh] px-2 md:px-6">
            <div class="w-full max-w-7xl mx-auto">
                ...
                <!-- Back Button & Header -->
                <div class="mb-6">
                    <a href="produk_shopee.php" class="inline-flex items-center gap-2 bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300 font-semibold text-sm px-4 py-2 rounded-lg shadow-sm transition mb-4">
                    ...
                    <div class="p-6 md:p-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                            ...
                            <div class="sticky top-6">
                                ...
                                <div class="relative">
                                    <button id="scroll-left" class="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 z-10 bg-white shadow-lg rounded-full w-8 h-8 flex items-center justify-center hover:bg-gray-100 transition opacity-0 disabled:opacity-0">
                                        <i class="fas fa-chevron-left text-gray-700 text-sm"></i>
                                    </button>
                                    
                                    <div id="thumbnail-container" class="flex gap-2 overflow-x-auto scroll-smooth hide-scrollbar">
                                    ...
                                    <button id="scroll-right" class="absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 z-10 bg-white shadow-lg rounded-full w-8 h-8 flex items-center justify-center hover:bg-gray-100 transition">
                            ...
                            <!-- Product Info -->
                            <div>
                                <h2 class="text-3xl font-bold text-gray-900 mb-4"><?php echo htmlspecialchars($product['item_name']); ?></h2>
                                ...
                                <div class="space-y-3 mb-6">
                                    <div class="flex items-center gap-3">
                                        <span class="stats-badge badge-stock">
                                            ...
                                            <span>Stok Shopee: <strong><?php echo htmlspecialchars($product['calculated_total_stock'] ?? $product['stock_info_v2']['summary_info']['total_available_stock'] ?? $product['stock_info'][0]['seller_stock'] ?? 0); ?></strong></span>
                                        </span>
                                    ...
                                    <div class="flex gap-2 flex-wrap">
                                        <span class="badge-id">ID: <?php echo htmlspecialchars($product['item_id']); ?></span>
                                        <?php if (!empty($product['item_sku'])): ?>
                                        <span class="badge-id">SKU: <?php echo htmlspecialchars($product['item_sku']); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <p class="text-gray-700 text-sm leading-relaxed whitespace-pre-line"><?php echo htmlspecialchars($product['description']); ?></p>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="border-t pt-8">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                ...
                                <div class="variant-card p-5">
                                    <div class="mb-4">
                                        <p class="font-bold text-gray-900 text-lg mb-3"><?php echo htmlspecialchars($model['model_name'] ?? 'Variation'); ?></p>
                                        <div class="flex gap-3 flex-wrap">
                                            <span class="text-xs" style="background: #dcfce7; color: #15803d; padding: 6px 10px; border-radius: 6px; font-weight: 600;">
                                                💰 Rp <span id="price-display-<?php echo $model['model_id']; ?>" class="variant-price"><?php echo formatPrice($model['price_info'][0]['original_price'] ?? 0); ?></span>
                                            </span>
                                            <span class="text-xs" style="background: #e0e7ff; color: #3730a3; padding: 6px 10px; border-radius: 6px; font-weight: 600;">
                                                SKU: <strong><?php echo htmlspecialchars($model['model_sku'] ?? ''); ?></strong>
                                            </span>
                                            <span class="text-xs" style="background: #dbeafe; color: #1e40af; padding: 6px 10px; border-radius: 6px; font-weight: 600;">
                                                📦 Stok Shopee: <strong id="stock-display-<?php echo $model['model_id']; ?>" class="variant-stock"><?php echo htmlspecialchars($model['stock_info_v2']['summary_info']['total_available_stock'] ?? $model['stock_info'][0]['seller_stock'] ?? 0); ?></strong>
                                            </span>
                                            <?php
                                    ...
                                    <div class="space-y-3">
                                        <form class="update-stock-form form-group" data-model-id="<?php echo $model['model_id']; ?>">
                                            ...
                                            <button type="submit" class="btn-action btn-stock rounded-xl whitespace-nowrap">Update</button>
                                        </form>
                                        ...
                                        <form class="update-price-form form-group" data-model-id="<?php echo $model['model_id']; ?>">
                                            ...
                                            <button type="submit" class="btn-action btn-price rounded-xl whitespace-nowrap">Update</button>
                                        </form>
                                        
                                        <form class="sync-stock-form" data-item-id="<?php echo htmlspecialchars($product['item_id']); ?>" data-model-id="<?php echo htmlspecialchars($model['model_id']); ?>">
                                            <input type="hidden" name="item_id" value="<?php echo htmlspecialchars($product['item_id']); ?>">
                                            <input type="hidden" name="model_id" value="<?php echo htmlspecialchars($model['model_id']); ?>">
                        ...
                        <div class="border-t pt-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <form class="update-stock-form form-group" data-item-id="<?php echo $product['item_id']; ?>">
                                    <input type="hidden" name="item_id" value="<?php echo htmlspecialchars($product['item_id']); ?>">
                                    <label class="text-sm font-semibold text-gray-700 whitespace-nowrap w-28">
                                        <i class="fas fa-box mr-1"></i> Stok Baru:
                                    </label>
                                ...
                                <form class="update-price-form form-group" data-item-id="<?php echo $product['item_id']; ?>">
                                    <input type="hidden" name="item_id" value="<?php echo htmlspecialchars($product['item_id']); ?>">
                                    <label class="text-sm font-semibold text-gray-700 whitespace-nowrap w-28">
                                        <i class="fas fa-tag mr-1"></i> Harga Baru:
                                    </label>
                                ...
                                <form class="sync-stock-form md:col-span-2" data-item-id="<?php echo htmlspecialchars($product['item_id']); ?>">
                                    <input type="hidden" name="item_id" value="<?php echo htmlspecialchars($product['item_id']); ?>">
                                    <input type="hidden" name="model_id" value="0">
                                    <input type="hidden" name="sku" value="<?php echo htmlspecialchars($product['item_sku']); ?>">
                                    <button type="submit" class="btn-action btn-sync rounded-xl w-full">
                                        <i class="fas fa-sync-alt mr-1"></i> Sinkronisasi Stok
                                    </button>
                                </form>
