...
<head>
    ...
    <title>Import Faktur Keluaran (Coretax)</title>
...
<body class="bg-gray-50">
                ...
                <div class="header-card p-4 rounded-2xl mb-6 bg-white shadow-sm border border-gray-100">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 class="text-xl font-bold text-gray-800 mb-1">Import Faktur Keluaran</h1>
                                <p class="text-xs text-gray-600">Upload file Excel Faktur Pajak Keluaran (Coretax).</p>
                            </div>
                        </div>

                        <a href="data_coretax_keluaran.php"
                        ...
                        <form id="formImport" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div class="lg:col-span-1 flex flex-col gap-6">
                                    ...
                                    <div class="mt-auto">
                                        <button type="submit" id="btn-submit"
                                            class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-xl shadow-lg shadow-indigo-200 transition-all transform hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-2">
                                ...
                                <div class="lg:col-span-2 h-full">
                                    ...
                                    <div class="relative h-full min-h-[300px] border-2 border-dashed border-indigo-300 bg-indigo-50/50 rounded-2xl text-center hover:bg-indigo-50 transition-colors cursor-pointer group flex flex-col items-center justify-center"
                                        id="drop-zone">
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto shadow-sm border border-indigo-100">
                                            ...
                                            <div class="px-4">
                                                ...
                                                <p class="text-gray-500 text-sm">
                                                    atau <span class="text-indigo-600 font-semibold underline">klik
                                                        untuk
                                                        mencari</span>
                                                </p>
                                            </div>
    ...
    <script src="../../js/coretax/import_handler_keluaran.js" type="module"></script>
