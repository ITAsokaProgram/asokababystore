          ...
          <form id="single-form" autocomplete="off">
            ...
            <div class="form-grid">
              <div>
                ...
                <select id="inp_kode_store" name="kode_store" class="input-compact bg-white cursor-pointer">
              ...
              <div class="relative">
                ...
                <p id="err_no_invoice" class="text-red-500 absolute -bottom-4 left-0 hidden font-semibold"
              ...
              <div>
                ...
                <input type="text" id="inp_dpp" name="dpp" class="input-compact text-right font-mono" value="0">
              </div>

              <div>
                <label class="form-label text-right">DPP Nilai Lain</label>
                <input type="text" id="inp_dpp_lain" name="dpp_nilai_lain" class="input-compact text-right font-mono"
                  value="0">
              </div>

              <div>
                <label class="form-label text-right">PPN</label>
                <input type="text" id="inp_ppn" name="ppn" class="input-compact text-right font-mono" value="0">
              </div>

              <div>
                <label class="form-label text-right">Total</label>
                <input type="text" id="inp_total" name="total"
                  class="input-compact text-right font-bold text-pink-600 input-readonly font-mono" readonly value="0">
              </div>

              <div class="flex items-end h-full pb-1">
                <button type="button" id="btn-cancel-edit"
                  class="hidden text-gray-400 hover:text-red-500 transition-colors" title="Batal Edit">
      ...
      <div x-show="show" x-transition:enter="transition ease-out duration-200"
        ...
        <div class="p-6">
          <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <p class="text-gray-700 text-sm leading-relaxed whitespace-pre-wrap break-words" x-text="content"></p>
          </div>
        </div>
