...
$menuHandler = new MenuHandler('pajak_faktur_masukan');
...
<body class="bg-gray-50 theme-receipt">
                ...
                <div class="header-card p-4 rounded-2xl mb-4">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 id="page-title" class="text-xl font-bold text-gray-800 mb-1">Laporan Penerimaan
                                </h1>
