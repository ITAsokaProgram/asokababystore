                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
                        ...
                        <div class="space-y-6">
                            <div class="filter-card">
                                <div class="mb-3 flex justify-between items-center border-b border-gray-100 pb-2">
                                    <label class="text-sm font-bold text-gray-800 flex items-center gap-2">
                                        <span class="bg-pink-100 text-pink-600 w-6 h-6 rounded-full flex items-center justify-center text-xs">1</span>
                                        Pilih Cabang (Store) <span class="text-red-500">*</span>
                                    </label>
                                    <div class="flex gap-2 text-xs">
                                        <button type="button" id="btn-select-all-cabang" class="text-pink-600 hover:text-pink-700 font-medium">All</button>
                                        <span class="text-gray-300">|</span>
                                        <button type="button" id="btn-deselect-all-cabang" class="text-gray-500 hover:text-gray-700">None</button>
                                    </div>
                                </div>
                            ...
                            <div class="filter-card transition-all duration-300" id="step-supplier">
                                <div class="mb-3 flex justify-between items-center border-b border-gray-100 pb-2">
                                    <label class="text-sm font-bold text-gray-800 flex items-center gap-2">
                                        <span class="bg-pink-100 text-pink-600 w-6 h-6 rounded-full flex items-center justify-center text-xs">2</span>
                                        Pilih Supplier <span class="text-red-500">*</span>
                                    </label>
                                    <div class="flex gap-2 text-xs">
                                        <button type="button" id="btn-select-all-supp" class="text-pink-600 hover:text-pink-700 font-medium">All</button>
                                        <span class="text-gray-300">|</span>
                                        <button type="button" id="btn-deselect-all-supp" class="text-gray-500 hover:text-gray-700">None</button>
                                    </div>
                                </div>
                                ...
                                <div class="mt-2 text-right">
                                    <span id="supplier-counter" class="text-xs font-semibold text-gray-500 badge badge-warning">0 supplier dipilih</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                            <div class="filter-card sticky">
                                <div class="mb-4 border-b border-gray-100 pb-2">
                                    <label for="tgl_schedule" class="text-sm font-bold text-gray-800 flex items-center gap-2">
                                        <span class="bg-pink-100 text-pink-600 w-6 h-6 rounded-full flex items-center justify-center text-xs">3</span>
                                ...
                                <div class="bg-pink-50 p-4 rounded-lg border border-pink-100 mb-4">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="text-xs text-gray-700">
                                            ...
                                            <p class="mt-1">Default Minimum: <span id="default-date-display" class="font-mono font-bold text-pink-700"></span></p>
                                        </div>
                                    </div>
                                </div>
