...
// Optional: Menu Handler check
// require_once __DIR__ . '/../../component/menu_handler.php';
// $menuHandler = new MenuHandler('log_serah_terima');
...
<head>
    ...
    <title>Log Serah Terima Nota</title>
    ...
    <style>
        /* Custom styles for JSON detail view */
        .detail-table {
            width: 100%;
...
<body class="bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                    <div class="summary-card total flex gap-4 items-center">
                        ...
                        <div>
                            <h3 class="text-xs font-semibold text-gray-600 mb-1">Total Logs</h3>
                            <p id="summary-total-logs" class="text-2xl font-bold truncate text-gray-900">-</p>
                        </div>
                    </div>
                    ...
                    <div class="summary-card flex gap-4 items-center" style="border-left: 4px solid #10b981;">
                        ...
                        <div>
                            <h3 class="text-xs font-semibold text-gray-600 mb-1">Input Baru</h3>
                            <p id="summary-insert" class="text-2xl font-bold truncate" style="color: #059669;">-</p>
                        </div>
                    </div>

                    <div class="summary-card flex gap-4 items-center" style="border-left: 4px solid #3b82f6;">
                        <div class="summary-icon" style="background-color: #dbeafe; color: #3b82f6;">
                            <i class="fas fa-pen fa-lg"></i>
                        </div>
                        <div>
                            <h3 class="text-xs font-semibold text-gray-600 mb-1">Perubahan</h3>
                            <p id="summary-update" class="text-2xl font-bold truncate" style="color: #1d4ed8;">-</p>
                        </div>
                    </div>

                    <div class="summary-card flex gap-4 items-center" style="border-left: 4px solid #ef4444;">
                        <div class="summary-icon" style="background-color: #fee2e2; color: #ef4444;">
                            <i class="fas fa-trash-alt fa-lg"></i>
                        </div>
                        <div>
                            <h3 class="text-xs font-semibold text-gray-600 mb-1">Dihapus</h3>
                            <p id="summary-delete" class="text-2xl font-bold truncate" style="color: #b91c1c;">-</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="filter-card-simple mt-4">
                    <form id="filter-form" class="grid grid-cols-1 md:grid-cols-4 gap-3 items-end">
                        ...
                        <div>
                            ...
                            <input type="text" name="search" id="search" placeholder="No Faktur atau User..."
                ...
                <div class="filter-card mt-4">
                    <div class="flex flex-wrap justify-between items-center mb-3 gap-3">
                        <h3 class="text-lg font-bold text-gray-800">
                            <i class="fas fa-file-invoice text-pink-600 mr-2"></i>
                            Log Operasi Nota
                        </h3>
                    </div>
    ...
    <script src="../../js/logs/serah_terima_nota_logs_handler.js" type="module"></script>
