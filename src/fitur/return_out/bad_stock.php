...
$menuHandler = new MenuHandler('laporan_return_badstock');
...
<head>
    ...
    <title>Laporan Return (Bad Stock)</title>
...
<body class="bg-gray-50">
                    ...
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            <div class="icon-wrapper">
                                <i class="fa-solid fa-box-damaged fa-lg"></i>
                            </div>
                            <div>
                                <h1 id="page-title" class="text-xl font-bold text-gray-800 mb-1">Laporan Return (Bad
                                    Stock)
                                </h1>
                                <p id="page-subtitle" class="text-xs text-gray-600">Memuat detail bad stock...</p>
                            </div>
                        </div>
                    </div>
    ...
    <script src="../../js/return_out/bad_stock_handler.js" type="module"></script>
