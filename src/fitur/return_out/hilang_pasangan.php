...
$menuHandler = new MenuHandler('laporan_return_hilang');
...
<head>
    ...
    <title>Laporan Return Out (Hilang Pasangan)</title>
...
<body class="bg-gray-50">
    ...
    <script src="../../js/return_out/hilang_pasangan_handler.js" type="module"></script>
