...
$menuHandler = new MenuHandler('laporan_return_exp');
...
<head>
    ...
    <title>Laporan Return Out (Expired)</title>
...
<body class="bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="header-card p-4 rounded-2xl mb-4">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            <div class="icon-wrapper">
                                <i class="fa-solid fa-calendar-times fa-lg"></i>
                            </div>
                            <div>
                                <h1 id="page-title" class="text-xl font-bold text-gray-800 mb-1">Laporan Return Out
                                    (Expired)
                                </h1>
                                <p id="page-subtitle" class="text-xs text-gray-600">Memuat detail return expired...</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                        <div class="summary-card total flex gap-4 items-center">
                            ...
                            <div>
                                <h3 class="text-xs font-semibold text-gray-600 mb-1">Total Qty Return</h3>
                ...
                <div class="filter-card">
                    ...
                    <div class="table-container">
                        <table class="table-modern" id="return-out-table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>PLU</th>
    ...
    <script src="../../js/return_out/exp_produk_handler.js" type="module"></script>
