...
<head>
    ...
    <title>Receipt by Supplier</title>
...
<body class="bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="header-card p-4 rounded-2xl mb-4">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 id="page-title" class="text-xl font-bold text-gray-800 mb-1">Receipt by Supplier
                                </h1>
                ...
                <div class="filter-card">
                    ...
                    <div class="table-container">
                        <table class="table-modern" id="supplier-receipt-table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Kode Supp</th>
                            ...
                            <tbody id="supplier-receipt-table-body">
                                <tr>
    ...
    <script src="../../js/penerimaan_receipt/by_supplier_handler.js" type="module"></script>
