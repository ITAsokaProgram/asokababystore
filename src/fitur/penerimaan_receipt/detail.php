...
$menuHandler = new MenuHandler('laporan_receipt_supplier');
...
<body class="bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="header-card p-4 rounded-2xl mb-4">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 id="page-title" class="text-xl font-bold text-gray-800 mb-1">Detail Receipt</h1>
                    ...
                    <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        ...
                        <div class="summary-card flex gap-4 items-center warning">
                            ...
                            <div>
                                ...
                                <p id="summary-ppn" class="text-2xl font-bold truncate text-yellow-600">-</p>
                            </div>
                        </div>
                        <div class="summary-card flex gap-4 items-center total">
                            ...
                            <div>
                                <h3 class="text-xs font-semibold text-gray-600 mb-1">Total Keseluruhan</h3>
                ...
                <div class="filter-card">
                    ...
                    <div class="table-container">
                        <table class="table-modern" id="detail-receipt-table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>PLU</th>
                            ...
                            <tbody id="detail-receipt-table-body">
                                <tr>
    ...
    <script src="../../js/penerimaan_receipt/detail_receipt_handler.js" type="module"></script>
