...
<head>
    ...
    <title>Laporan Return (Retur)</title>
                ...
                <div class="header-card p-4 rounded-2xl mb-4">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 class="text-xl font-bold text-gray-800 mb-1">Data Return</h1>
                                <p class="text-xs text-gray-600">Laporan pengembalian barang ke supplier.</p>
                            </div>
                        </div>
                        <a href="create.php"
