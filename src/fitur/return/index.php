...
<head>
    ...
    <title>Checking Return (Retur)</title>
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="header-card p-4 rounded-2xl mb-4">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 class="text-xl font-bold text-gray-800 mb-1">Checking Return</h1>
                            </div>
                        </div>
                        <a href="create.php"
                            class="btn-primary inline-flex items-center justify-center gap-2 no-underline">
                            <i class="fa-solid fa-plus"></i>
                            <span>Buat Return</span>
                        </a>
                    </div>
                    ...
                    <div class="mt-4 grid grid-cols-1 md:grid-cols-4 gap-3">
                        ...
                        <div id="btn-show-missing"
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-gray-500">Ada di Retur, Belum di Check</p>
                            </div>
                        </div>
                        ...
                        <div id="btn-show-notfound"
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-gray-500">Ada di Check, Tidak ada di Retur</p>
                            </div>
                        </div>
                ...
                <div class="filter-card-simple mb-4">
                    <form id="filter-form" class="grid grid-cols-1 md:grid-cols-4 gap-3 items-end">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-700 mb-2">Dari Tanggal
                                (Retur/Check)</label>
                ...
                <div class="filter-card">
                    <div class="table-container">
                        <table class="table-modern" id="return-table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    ...
                                    <th>Kd Supplier</th>
                                    <th>No Faktur</th>
                                    <th class="text-right">Total Check</th>
                                    <th>Keterangan</th>
                                </tr>
                            </thead>
            ...
            <div class="flex min-h-screen items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div x-show="detailModalOpen" x-transition:enter="ease-out duration-300"
                    ...
                    <div class="bg-pink-50 px-4 py-3 sm:px-6 flex justify-between items-center">
                        <h3 class="text-lg font-bold leading-6 text-pink-700">Detail Return</h3>
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="mt-4 grid grid-cols-2 gap-4">
                            <div class="bg-gray-50 p-2 rounded border border-gray-100">
                                <p class="text-[10px] font-bold tracking-wider text-gray-400 uppercase mb-1">Total
                                    System (ERP)</p>
                                <p class="text-base font-bold text-gray-700"
                                    x-text="'Rp ' + formatRupiah(detailData.total_erp)"></p>
                            </div>
                            <div class="bg-blue-50 p-2 rounded border border-blue-100 text-right">
                                <p class="text-[10px] font-bold tracking-wider text-blue-400 uppercase mb-1">Total Fisik
                                    (Check)</p>
                                <p class="text-base font-bold text-blue-700"
                                    x-text="'Rp ' + formatRupiah(detailData.total_check)"></p>
                            </div>
                        </div>

                        <div
                            class="mt-2 bg-white border border-gray-200 p-3 rounded-lg flex justify-between items-center shadow-sm">
                            <span class="text-sm text-gray-600 font-medium">Selisih (System - Fisik)</span>
                            <span class="text-lg font-bold font-mono"
                                :class="detailData.nilai_selisih_row != 0 ? 'text-red-600' : 'text-green-600'"
                                x-text="(detailData.nilai_selisih_row < 0 ? '- ' : '') + 'Rp ' + formatRupiah(Math.abs(detailData.nilai_selisih_row))"></span>
                        </div>
                                    ...
                                    <div class="flex justify-between items-center">
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-sm font-medium text-gray-700"
                                                x-text="formatDate(item.tgl_return)"></span>
                                            <span class="text-xs text-gray-500" x-text="item.no_faktur"></span>
                                        </div>
