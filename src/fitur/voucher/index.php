...
$menuHandler = new MenuHandler('voucher_index');
...
<body class="bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="header-card p-4 rounded-2xl mb-4">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 id="page-title" class="text-xl font-bold text-gray-800 mb-1">Laporan Voucher</h1>
                                <p id="page-subtitle" class="text-xs text-gray-600">Memuat detail voucher...</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form id="filter-form" class="grid grid-cols-1 md:grid-cols-4 gap-3 items-end" method="GET"
                        ...
                        <div>
                            <label for="tgl_mulai" class="block text-xs font-semibold text-gray-700 mb-2">
                                <i class="fas fa-calendar-alt text-pink-600 mr-1"></i> Dari Tanggal (Awal)
                            </label>
                        ...
                        <div>
                            <label for="tgl_selesai" class="block text-xs font-semibold text-gray-700 mb-2">
                                <i class="fas fa-calendar-alt text-pink-600 mr-1"></i> Sampai Tanggal (Awal)
                            </label>
                ...
                <div class="filter-card">
                    ...
                    <div class="table-container">
                        <table class="table-modern" id="voucher-table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Kode Voucher</th>
    ...
    <script src="../../js/voucher/handler.js" type="module"></script>
