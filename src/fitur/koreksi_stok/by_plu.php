...
<head>
    ...
    <title>Laporan Koreksi (PLU)</title>
...
<body class="bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="header-card p-4 rounded-2xl mb-4">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 id="page-title" class="text-xl font-bold text-gray-800 mb-1">Laporan Koreksi (PLU)
                                </h1>
                    ...
                    <form id="filter-form" class="grid grid-cols-1 md:grid-cols-4 gap-3 items-end" method="GET"
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <input type="text" name="search_query" id="search_query" class="input-modern w-full"
                                placeholder="No Faktur / PLU / Nama / No Koreksi"
                ...
                <div class="filter-card">
                    ...
                    <div class="table-container">
                        <table class="table-modern" id="koreksi-plu-table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>PLU</th>
                            ...
                            <tbody id="koreksi-plu-table-body">
                                <tr>
    ...
    <script src="../../js/koreksi_stock/by_plu_handler.js" type="module"></script>
