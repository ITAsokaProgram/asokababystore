    ...
    <main id="main-content" class="flex-1 p-4 ml-64">
        <section class="min-h-screen">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="filter-card mt-4" id="detail-faktur-container" style="display: none;">
                    <div class="flex flex-wrap justify-between items-center mb-3 gap-3">
                        <h3 class="text-lg font-bold text-gray-800">
                            <i class="fas fa-file-invoice text-pink-600 mr-2"></i>
                            Detail Faktur: <span id="detail-faktur-title" class="text-pink-600">-</span>
                        </h3>
                        <button onclick="closeDetailFaktur()" class="text-gray-500 hover:text-gray-700">
                            <i class="fas fa-times text-xl"></i>
                        </button>
                    </div>
                    <div id="detail-faktur-content" class="overflow-x-auto">
                    </div>
                </div>
            </div>
        </section>
