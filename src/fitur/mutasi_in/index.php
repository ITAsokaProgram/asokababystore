...
$default_kd_store_tujuan = 'all'; // Default tujuan
...
$kd_store_tujuan = $_GET['kd_store_tujuan'] ?? $default_kd_store_tujuan; // Get param tujuan
                ...
                <div class="filter-card-simple mb-4 p-4">
                    <form id="filter-form">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                            ...
                            <div class="lg:col-span-1">
                                ...
                                <div class="relative">
                                    <input type="text" name="search_query" id="search_query"
                                        class="input-modern w-full h-9 pl-3 text-sm" placeholder="No Faktur / MMD..."
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-1">Cabang Pengirim
                                    (Dari)</label>
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-1">Cabang Penerima
                                    (Tujuan)</label>
                                <select name="kd_store_tujuan" id="kd_store_tujuan"
                                    class="input-modern w-full h-9 text-sm">
                            ...
                            <div>
                                ...
                                <select name="status_cetak" id="status_cetak" class="input-modern w-full h-9 text-sm">
                            ...
                            <div>
                                ...
                                <select name="status_terima" id="status_terima" class="input-modern w-full h-9 text-sm">
                                    <option value="all">Semua Status</option>
                            ...
                            <div class="md:col-span-2 lg:col-span-4 flex justify-end mt-2">
                                <button type="submit" id="filter-submit-button"
                                    class="btn-primary inline-flex items-center justify-center gap-2 h-9 px-6 text-sm">
                                    <i class="fas fa-filter"></i> <span>Tampilkan Data</span>
                                </button>
                            </div>
                        </div>
