            ...
            <div class="max-w-4xl mx-auto">
                ...
                <form id="formReceipt" class="filter-card">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-700 mb-1">Tanggal Receipt <span class="text-red-500">*</span></label>
                            <input type="date" name="tgl_receipt" id="tgl_receipt" class="input-modern w-full" required value="<?= date('Y-m-d') ?>">
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-gray-700 mb-1">Nomor Faktur <span class="text-red-500">*</span></label>
                            <input type="text" name="no_faktur" id="no_faktur" class="input-modern w-full uppercase" placeholder="Contoh: 1900-RC..." required>
                        </div>

                        <div class="relative">
                            <label class="block text-xs font-semibold text-gray-700 mb-1">Kode Supplier <span class="text-red-500">*</span></label>
                            <div class="relative">
                                <input type="text" name="kode_supp" id="kode_supp" class="input-modern w-full uppercase" placeholder="Ketik Kode (Misal: A046)..." required autocomplete="off">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_supplier" id="nama_supplier" class="input-modern w-full uppercase" placeholder="Nama PT/Supplier">
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-gray-700 mb-1">Total Penerimaan (Rp)</label>
                            <input type="text" name="total_penerimaan_display" id="total_penerimaan_display" class="input-modern w-full" placeholder="0" onkeyup="formatCurrency(this)">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="keterangan" id="keterangan" class="input-modern w-full h-24" placeholder="Keterangan tambahan..."></textarea>
                        </div>
