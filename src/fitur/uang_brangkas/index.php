                    ...
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p id="page-subtitle" class="text-xs text-gray-600">Pencatatan fisik uang (Cash Opname).</p>
                            </div>
                        </div>
                ...
                <form id="form-transaksi">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="flex justify-between items-center mb-4 border-b pb-2">
                            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Input Uang Brangkas</h3>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            <div class="lg:col-span-1 space-y-4">
                                ...
                                <div class="p-3 border border-red-200 rounded-lg bg-red-50">
                                    ...
                                    <div class="mb-2">
                                        <label class="block text-xs font-semibold text-gray-700 mb-1">User Check (Nama Pengguna)</label>
                                        <input type="text" name="nama_user_cek" id="nama_user_cek"
                                            class="input-modern w-full" placeholder="Ketik Nama Inisial" required autocomplete="off">
                                    </div>
                                    <div id="div-password">
                                ...
                                <div>
                                    ...
                                    <textarea name="keterangan" id="keterangan" rows="2" class="input-modern w-full"></textarea>
                                </div>
                            </div>

                            <div class="lg:col-span-2">
                                <div class="text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Uang Kertas</div>
                                <div class="grid grid-cols-2 gap-4 mb-4">
                                    <div class="flex items-center justify-between bg-gray-50 p-2 rounded">
                                        <label class="text-sm font-medium w-16">100.000</label>
                                        <input type="number" name="qty_100rb" class="input-denim input-modern w-24 text-right" min="0" value="0">
                                    </div>
                                    <div class="flex items-center justify-between bg-gray-50 p-2 rounded">
                                        <label class="text-sm font-medium w-16">5.000</label>
                                        <input type="number" name="qty_5rb" class="input-denim input-modern w-24 text-right" min="0" value="0">
                                    </div>

                                    <div class="flex items-center justify-between bg-gray-50 p-2 rounded">
                                        <label class="text-sm font-medium w-16">50.000</label>
                                        <input type="number" name="qty_50rb" class="input-denim input-modern w-24 text-right" min="0" value="0">
                                    </div>
                                    <div class="flex items-center justify-between bg-gray-50 p-2 rounded">
                                        <label class="text-sm font-medium w-16">2.000</label>
                                        <input type="number" name="qty_2rb" class="input-denim input-modern w-24 text-right" min="0" value="0">
                                    </div>

                                    <div class="flex items-center justify-between bg-gray-50 p-2 rounded">
                                        <label class="text-sm font-medium w-16">20.000</label>
                                        <input type="number" name="qty_20rb" class="input-denim input-modern w-24 text-right" min="0" value="0">
                                    </div>
                                    <div class="flex items-center justify-between bg-gray-50 p-2 rounded">
                                        <label class="text-sm font-medium w-16">1.000</label>
                                        <input type="number" name="qty_1rb" class="input-denim input-modern w-24 text-right" min="0" value="0">
                                    </div>

                                    <div class="flex items-center justify-between bg-gray-50 p-2 rounded">
                                        <label class="text-sm font-medium w-16">10.000</label>
                                        <input type="number" name="qty_10rb" class="input-denim input-modern w-24 text-right" min="0" value="0">
                                    </div>
                                    <div></div> 
                                </div>

                                <div class="text-xs font-bold text-gray-500 uppercase tracking-wide mb-2 mt-4">Uang Koin</div>
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="flex items-center justify-between bg-gray-50 p-2 rounded">
                                        <label class="text-sm font-medium w-16">1.000</label>
                                        <input type="number" name="qty_1000_koin" class="input-denim input-modern w-24 text-right" min="0" value="0">
                                    </div>
                                    <div class="flex items-center justify-between bg-gray-50 p-2 rounded">
                                        <label class="text-sm font-medium w-16">100</label>
                                        <input type="number" name="qty_100_koin" class="input-denim input-modern w-24 text-right" min="0" value="0">
                                    </div>

                                    <div class="flex items-center justify-between bg-gray-50 p-2 rounded">
                                        <label class="text-sm font-medium w-16">500</label>
                                        <input type="number" name="qty_500_koin" class="input-denim input-modern w-24 text-right" min="0" value="0">
                                    </div>
                                    <div></div>

                                    <div class="flex items-center justify-between bg-gray-50 p-2 rounded">
                                        <label class="text-sm font-medium w-16">200</label>
                                        <input type="number" name="qty_200_koin" class="input-denim input-modern w-24 text-right" min="0" value="0">
                                    </div>
                                    <div></div>
                                </div>
                            </div>
