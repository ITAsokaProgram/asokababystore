...
<head>
    ...
    <title>Top Sales by Quantity</title>
...
<body class="bg-gray-50">
                ...
                <div class="header-card p-4 rounded-2xl mb-4">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 id="page-title" class="text-xl font-bold text-gray-800 mb-1">Top Sales by (Qty)
                                </h1>
                    ...
                    <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <div class="summary-card total flex gap-4 items-center">
                            ...
                            <div>
                                <h3 class="text-xs font-semibold text-gray-600 mb-1">Total Quantity Terjual</h3>
                                <p id="summary-total-qty" class="text-2xl font-bold truncate text-gray-900">-</p>
                            </div>
                        </div>
                        <div class="summary-card flex gap-4 items-center success">
                            ...
                            <div>
                                ...
                                <p id="summary-net-sales" class="text-2xl font-bold truncate text-green-600">-</p>
                            </div>
                        </div>
                        <div class="summary-card flex gap-4 items-center danger">
                            ...
                            <div>
                                ...
                                <p id="summary-grs-margin" class="text-2xl font-bold truncate text-red-600">-</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="../../js/top_sales/by_qty_handler.js" type="module"></script>
