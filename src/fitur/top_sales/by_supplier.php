...
$menuHandler = new MenuHandler('laporan_topsales_supplier');
...
<head>
    ...
    <title>Top Sales by Supplier</title>
...
<body class="bg-gray-50">
                ...
                <div class="header-card p-4 rounded-2xl mb-4">
                    <div class="flex items-center justify-between flex-wrap gap-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 id="page-title" class="text-xl font-bold text-gray-800 mb-1">Top Sales by (Supplier)
                                </h1>
    ...
    <script src="../../js/top_sales/by_supplier_handler.js" type="module"></script>
