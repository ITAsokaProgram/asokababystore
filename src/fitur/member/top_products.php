...
<head>
    ...
    <title>Top Selling Products - Asoka Baby Store</title>
...
<body class="bg-gray-50 flex">
            ...
            <div class="mb-4 flex flex-col md:flex-row items-center justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-yellow-700 flex items-center gap-3">
                        <i class="fas fa-box-open text-yellow-500"></i> Top Selling Products
                    </h1>
                    <p class="text-gray-600 mt-1">Analisis produk terlaris berdasarkan penjualan</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                <div class="card-glass p-3">
                    <h3 class="text-xl font-bold text-yellow-700 flex items-center gap-2 mb-3">
                        <i class="fas fa-medal text-yellow-500"></i> Top 50 Produk (Member)
                    </h3>
                    <div class="space-y-2 overflow-x-hidden" id="top-products-member">
                    </div>
                </div>
                <div class="card-glass p-3">
                    <div class="flex items-center justify-between mb-3">
                        <h3 class="text-xl font-bold text-yellow-700 flex items-center gap-2">
                            <i class="fas fa-chart-bar text-yellow-500"></i> Top 50 Produk (Non-Member)
                        </h3>
                    </div>
                    <div class="space-y-2 overflow-x-hidden" id="top-products-non-member">
                    </div>
                </div>
            </div>
            ...
            <div class="card-glass overflow-hidden">
                <div class="px-4 py-3 border-b border-yellow-100">
                    <div class="flex flex-col md:flex-row items-center justify-between gap-2 flex-wrap">
                        <h3 class="text-xl font-bold text-yellow-700 flex items-center gap-2">
                            <i class="fas fa-list text-yellow-500"></i> Daftar Top Selling Products
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <select id="sort-select"
                                ...
                                <option value="qty">Sort by Total Quantity</option>
                            </select>
                            <button onclick="exportTopProductsData()"
                    ...
                    <table class="min-w-full divide-y divide-yellow-100">
                        <thead class="bg-gradient-to-r from-yellow-400 to-yellow-600 text-white">
                            <tr>
                                ...
                                <th class="px-3 py-2 text-left text-xs font-bold uppercase tracking-wider">Nama Produk
                                </th>
                                <th class="px-3 py-2 text-left text-xs font-bold uppercase tracking-wider">PLU</th>
                        ...
                        <tbody class="bg-white divide-y divide-yellow-50" id="top-products-table-body">
                        </tbody>
                    </table>
                </div>
                ...
                <div id="empty-state" class="hidden p-4 text-center glass-container animate-fade-in-up">
                    <i class="fas fa-box-open text-4xl text-yellow-200 mb-2"></i>
                    <h3 class="text-lg font-bold text-yellow-700 mb-1">Belum ada data</h3>
                    <p class="text-yellow-400">Data produk terlaris akan muncul di sini</p>
                </div>
            </div>
    ...
    <script type="module" src="/src/js/member_internal/product/display_top_products.js"></script>

    <script>
        // (Salin semua script <script> inline dari file top_sales.php Anda ke sini)
        // Script untuk sidebar toggle, profile card, dll.
