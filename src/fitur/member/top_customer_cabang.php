...
<head>
    ...
    <title>Customer Per Cabang</title>
...
<body class="bg-gradient-to-br from-slate-50 to-blue-50 text-gray-900">
            ...
            <div class="member-card fade-in p-4">
                <div class="page-header">
                    <h1 class="page-title">
                        ...
                        Top Customer per Cabang
                    </h1>
                    <p class="page-subtitle">
                        Pilih cabang untuk melihat leaderboard customer yang paling sering belanja di sana.
                        <br>Filter Waktu: <strong><?php echo $filter_display; ?></strong>
                    </p>
                </div>
                ...
                <div class="mt-4 flex flex-wrap items-end gap-3 justify-between">
                    ...
                    <div class="flex items-end gap-2 w-full md:w-auto">
                        <div class="relative w-full md:w-64">
                            <label for="cabang-filter" class="block text-xs font-medium text-gray-500 mb-1">
                                Pilih Cabang
                            </label>
            ...
            <div class="member-card slide-up p-4">
                ...
                <div id="initial-state" class="text-center py-12">
                    <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-blue-100 mb-4">
                        <i class="fa-solid fa-shop text-3xl text-blue-600"></i>
                    </div>
                    <h3 class="text-lg font-medium text-gray-900">Belum ada data ditampilkan</h3>
                    <p class="text-gray-500 mt-1">Silakan pilih cabang dan klik "Cari" untuk melihat data.</p>
                </div>

                <div id="loading-spinner" class="loading-spinner hidden">
                    <i class="fa-solid fa-spinner fa-spin"></i>
                    <p class="loading-text">Menganalisa data transaksi per cabang...</p>
                </div>
    ...
    <script type="module" src="../../js/member/top_customer_cabang_handler.js"></script>
</body>
