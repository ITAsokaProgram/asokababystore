...
<body class="bg-gray-50 flex">
    ...
    <main id="main-content" class="flex-1 p-8 transition-all duration-300 ml-64 mt-16 bg-gray-100">
        ...
        <div class="mb-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <h1 class="text-3xl font-bold text-emerald-700 flex items-center gap-3"><i class="fas fa-chart-line text-emerald-500"></i> Produk Favorit Member</h1>
                ...
                <table class="min-w-full divide-y divide-emerald-100">
                    <thead class="bg-gradient-to-r from-emerald-500 to-emerald-700 text-white">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-bold uppercase tracking-wider">Produk Favorit</th>
                            <th class="px-6 py-3 text-center text-xs font-bold uppercase tracking-wider">Terjual</th>
                            <th class="px-6 py-3 text-center text-xs font-bold uppercase tracking-wider">Total Harga</th>
                        </tr>
                    </thead>
