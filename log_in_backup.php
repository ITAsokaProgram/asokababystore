...
<body
  ...
  <div class="fixed inset-0 overflow-hidden pointer-events-none">
    ...
    <div class="absolute top-40 right-20 w-24 h-24 bg-purple-300 rounded-full opacity-20 float-animation"
      style="animation-delay: 1s;"></div>
    <div class="absolute bottom-20 left-1/4 w-20 h-20 bg-blue-300 rounded-full opacity-20 float-animation"
      style="animation-delay: 2s;"></div>
    <div class="absolute bottom-40 right-1/3 w-28 h-28 bg-pink-200 rounded-full opacity-20 float-animation"
      style="animation-delay: 0.5s;"></div>
  </div>

  <div
    class="w-full max-w-6xl bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row card-hover-effect transition-all duration-500 border border-white/20">
      ...
      <div id="form-container" class="w-full transition-all duration-500">
        ...
        <div id="login-form" class="w-full space-y-6">
          ...
          <div class="space-y-3">
            <button type="button" id="google-login"
              class="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 p-4 rounded-xl transition-all duration-300 hover:bg-gray-50 hover:border-pink-300 hover:shadow-lg hover:-translate-y-1">
          ...
          <div id="loginSuccess"
            class="hidden text-center p-4 bg-green-100 text-green-700 rounded-xl border border-green-200">
          ...
          <div class="text-center space-y-3">
            <div class="text-sm text-gray-600">
              ...
              <button id="show-register"
                class="text-pink-600 font-semibold hover:text-pink-700 hover:underline transition-colors">Daftar
                Sekarang</button>
            </div>
            <div class="text-sm">
          ...
          <div class="text-center">
            <div class="text-sm text-gray-600">
              ...
              <button id="show-login"
                class="text-pink-600 font-semibold hover:text-pink-700 hover:underline transition-colors">Login</button>
            </div>
          </div>
        </div>
        ...
        <div id="forgot-form" class="w-full hidden space-y-6">
          ...
          <div class="flex border-b border-gray-200">
            <button id="tab-email"
              class="flex-1 py-3 px-4 text-center font-semibold text-pink-600 border-b-2 border-pink-600 focus:outline-none">
          ...
          <form id="forgotFormEmail" method="POST" class="space-y-5">
            <div class="space-y-2">
              ...
              <div id="forgotEmailError" class="hidden text-sm text-red-500 mt-1"><i
                  class="fas fa-exclamation-circle mr-1"></i>Email tidak valid</div>
            </div>
            <button type="submit"
              class="w-full bg-gradient-to-r from-red-500 to-pink-600 hover:opacity-90 transition-all text-white py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 relative"
              id="resetButtonEmail">
          ...
          <form id="forgotFormHp" method="POST" class="space-y-5 hidden">
            <div class="space-y-2">
              ...
              <div class="relative">
                <i class="fas fa-phone absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                <input type="tel" name="no_hp" id="forgotHp" placeholder="Contoh: 081234567890"
                  class="w-full border-2 border-gray-200 pl-10 pr-4 py-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500 transition-all text-lg" />
              </div>
              <div id="forgotHpError" class="hidden text-sm text-red-500 mt-1"><i
                  class="fas fa-exclamation-circle mr-1"></i>Format nomor HP tidak valid</div>
            </div>
            <button type="submit"
              class="w-full bg-gradient-to-r from-green-500 to-teal-600 hover:opacity-90 transition-all text-white py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 relative"
              id="resetButtonHp">
        ...
        <div id="number-phone" class="w-full hidden space-y-6">
          ...
          <form id="numberPhoneForm" method="POST" class="space-y-5">
            ...
            <button type="submit" id="loginWithPhone"
              class="w-full bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 transition-all duration-300 text-white py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105">
              <i class="fas fa-mobile-alt mr-2"></i>Masuk
            </button>
          </form>

          <div class="text-center">
            <button id="show-login3"
              class="text-pink-600 font-semibold hover:text-pink-700 hover:underline transition-colors">
