...
<body class="bg-gradient-to-br from-pink-50 via-white to-purple-50 min-h-screen text-gray-800">
    <div class="max-w-4xl mx-auto p-4 pb-20 space-y-6">
        ...
        <section class="mb-6">
            <div
                class="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 rounded-3xl shadow-2xl p-6 text-white overflow-hidden card-hover-effect transition-all duration-500 hover:shadow-purple-500/25 hover:scale-[1.01]">

                <!-- Background Pattern -->
                <div class="absolute inset-0 opacity-10">
                    <div
                        class="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full -translate-y-20 translate-x-20">
                    </div>
                    <div
                        class="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-blue-400 to-purple-400 rounded-full translate-y-16 -translate-x-16">
                    </div>
                    <div
                        class="absolute top-1/2 left-1/2 w-24 h-24 bg-gradient-to-bl from-pink-400 to-purple-400 rounded-full opacity-50 -translate-x-12 -translate-y-12">
                    </div>
                </div>
                ...
                <div class="relative z-10 flex items-start justify-between mb-8">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative">
                            <div
                                class="w-16 h-16 bg-gradient-to-br from-purple-400 to-pink-400 rounded-2xl flex items-center justify-center shadow-xl float-animation">
                                <i class="fas fa-user-circle text-3xl text-white"></i>
                            </div>
                            <!-- Online Indicator -->
                            <div
                                class="absolute -bottom-1 -right-1 w-5 h-5 bg-green-400 rounded-full flex items-center justify-center border-2 border-slate-900">
                    ...
                    <div class="text-right">
                        <div
                            class="inline-flex items-center space-x-2 backdrop-blur-sm rounded-full border border-white/20">
                ...
                <div class="relative z-10 mb-8">
                    <p class="text-purple-200 text-sm leading-relaxed">
                        Terima kasih telah menjadi member setia kami. Nikmati berbagai keuntungan eksklusif dan
                        kumpulkan poin rewards setiap pembelian di
                ...
                <div class="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <button onclick="window.location='/customer/history_poin'"
                            class="w-full flex items-center justify-center space-x-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-xl py-3 px-4 transition-all duration-300 hover:scale-105 border border-white/20">
                ...
                <div
                    class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500">
                </div>

                <!-- Shine Effect -->
                <div
                    class="absolute inset-0 bg-gradient-to-r from-transparent via-white/3 to-transparent -skew-x-12 translate-x-[-200%] hover:translate-x-[200%] transition-transform duration-1500">
                </div>
            </div>
        </section>
        ...
        <section class="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl p-6 border border-pink-100">
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 p-4 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full flex items-center justify-center">
                        <i class="fas fa-history text-white"></i>
                    </div>
                    <h2 class="text-xl font-bold text-gray-800">Riwayat Transaksi</h2>
                </div>
                <a href="history"
                    class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-full text-sm font-semibold hover:from-pink-600 hover:to-purple-700 transition-all duration-300 hover:scale-105 shadow-lg">
            ...
            <div class="space-y-3" id="transaksi-container">
                <div id="transaksi-loader" class="text-center py-8">
                    <div
                        class="w-12 h-12 border-4 border-pink-200 border-t-pink-500 rounded-full animate-spin mx-auto mb-4">
                    </div>
        ...
        <section class="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl p-6 border border-pink-100">
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 p-4 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center">
                ...
                <a href="promo"
                    class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-yellow-400 to-orange-500 text-white rounded-full text-sm font-semibold hover:from-yellow-500 hover:to-orange-600 transition-all duration-300 hover:scale-105 shadow-lg">
                    <i class="fas fa-external-link-alt text-xs"></i>
                    Lihat Semua
                </a>
            </div>
    ...
    <div id="imageModal"
        class="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 hidden pb-20">
        <div class="relative w-full h-full flex items-center justify-center p-4">
            <img id="modalImage" class="max-w-full max-h-full rounded-2xl shadow-2xl object-contain" />
            <button onclick="closeModal()"
                class="absolute top-4 right-4 w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-white/30 transition-all duration-300">
    ...
    <div id="fab-container" class="fixed bottom-20 right-5 z-50 flex flex-col-reverse items-center gap-4">
        ...
        <div id="fab-menu"
            class="hidden flex flex-col-reverse items-center gap-4 transition-all duration-300 ease-in-out">
            ...
            <div class="relative">
                ...
                <?php if ($totalUnreadCount > 0): ?>
                    <span
                        class="absolute -top-1 -right-1 w-5 h-5 bg-red-500 text-white text-xs rounded-full flex items-center justify-center border-2 border-white animate-pulse">
