...
<head>
    ...
    <title>Panduan Penghapusan Data - Asoka Baby Store</title>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 md:p-12 border border-gray-200">
            ...
            <div class="bg-blue-50 rounded-xl p-6 border border-blue-200">
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        <h3 class="text-xl font-bold text-gray-800 mb-3">Prosedur Penghapusan Akun Secara Langsung</h3>
                        <p class="text-gray-600 text-sm mb-4">Silakan ikuti langkah-langkah di bawah ini:</p>
                        <ol class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-green-300">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-sm text-gray-600">Estimasi Waktu Pemrosesan:</p>
                                    <p class="font-semibold text-gray-800">24 Jam</p>
                                </div>
                            </div>
                        </div>
